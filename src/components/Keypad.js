...
const Keypad = () => {
  return (
    <div className="keypad">
      <Key position="head" keyType={TYPE_CLEAR} keySymbol="C" keyValue="clear" />
      <Key
        position="head"
        ...
        keyValue="+/-"
      />
      <Key position="head" keyType={TYPE_PERCENTAGE} keySymbol="%" keyValue="%" />
      <Key position="aside" keyType={TYPE_OPERATOR} keySymbol="÷" keyValue="/" />
